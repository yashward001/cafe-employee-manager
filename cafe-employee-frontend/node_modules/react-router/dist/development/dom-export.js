...
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunkVNR6V74Njs.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, targetRoutes) => {
    ...
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunkVNR6V74Njs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
...
function createRouteFromServerManifest(match, payload) {
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunkVNR6V74Njs.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunkVNR6V74Njs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
